    ...
    <header class="page-header">
      <div>
        ...
        <p class="page-description">
          Renseignez les informations de votre article puis publiez-le.
        </p>
      </div>
    ...
    <form class="form-card" @submit="onSubmit">
      <fieldset :disabled="isSubmitting" class="form-grid">
        ...
        <label>
          ...
          <small class="helper">Laissez vide pour générer un slug automatiquement.</small>
        </label>
...
const { values, errors, isSubmitting, handleSubmit } = useForm<AdminPostPayload>({
  initialValues: {
    title: '',
    slug: '',
    content: '',
...
const onSubmit = handleSubmit(async (formValues) => {
  ...
  try {
    ...
    console.error(err)
    submitError.value = 'Impossible de créer cet article. Réessayez plus tard.'
  }
})
</script>
